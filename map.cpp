...
static unsigned XY_KEY(int X, int Y)
{
    ...
    return (X + Y) * (X + Y + 1) / 2 + Y; // I use Cantor pairing function
}
...
void maps_init()
{
    ...
    for (int i = 0; i < NUM_MAPS; i++)
    {
        ...
        if (i == 0)
        {
            maps[i].w = 65;    // set width
            maps[i].h = 65;    // set height
            maps[i].index = 0; // set index
        }
        else
        {
            maps[i].w = 21;    // set width
            maps[i].h = 21;    // set height
            maps[i].index = 1; // set index
        }
    }
...
void add_slain_buzz1(int x, int y)
{
    //****************
    // TODO: Implement
    //****************
...
void add_slain_buzz2(int x, int y)
{
    //****************
    // TODO: Implement
    //****************
